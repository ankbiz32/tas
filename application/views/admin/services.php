          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header row">
                ...
                <button class="btn btn-primary ml-auto" data-toggle="modal" data-target="#add">+ Add new Service</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="modal fade" id="edit<?=$d->id?>">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-body">
                                    <form role="form" method="post" action="<?php echo base_url();?>Edit/Service/<?=$d->id?>" enctype="multipart/form-data">
                                      <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="heading" class="m-0">Service name:</label>
 ...
 <!-- Add modal -->
  <div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form role="form" method="post" action="<?php echo base_url();?>Add/Service" enctype="multipart/form-data">
              <div class="col">
                <div class="form-group">
