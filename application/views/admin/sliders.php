...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fa fa-film"></i>&nbsp;&nbsp;Sliders</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header row">
                ...
                <button class="btn btn-primary ml-auto" data-toggle="modal" data-target="#add">+ Add new Slide</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="modal fade" id="edit<?=$d->id?>">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title"> <i class="fa fa-edit"></i> &nbsp; Edit Slide:</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form role="form" method="post" action="<?php echo base_url();?>Edit/Slide/<?=$d->id?>" enctype="multipart/form-data">
                                      <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="heading" class="m-0">Slide Heading:</label>
                                            <p class="text-sm text-muted m-0">(Max. 50 Characters)</p>
 ...
 <!-- Add modal -->
  <div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form role="form" method="post" action="<?php echo base_url();?>Add/Slide" enctype="multipart/form-data">
              <div class="col">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="heading" class="m-0">Slide Heading:</label>
                    <p class="text-sm text-muted">(Max. 50 Characters)</p>
                    <input type="text" class="form-control" name="heading" maxlength="50" id="heading" required>
                </div>
                <div class="form-group">
                    <label for="content" class="m-0">Description:</label>
