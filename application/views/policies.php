<div class="sub-header" style="background:linear-gradient(to right, rgba(0,0,0,0.6) 40%,rgba(0,0,0,0.1)), url(<?=base_url('assets/images/policies_header.jpg')?>);">
        <div class="wrapper">
    ...
    <section class="policy wow fadeInUp" data-wow-delay="0.6s">
        <div class="wrapper">
            ...
            <p>By mere use of the Website, you expressly consent to our use and disclosure of personal information provided by you in accordance with this Privacy Policy. This Privacy Policy is incorporated into and subject to the Terms of Use.</p>
            ...
            <p>Our Website links to other websites that may collect personally identifiable information about you. Ramrajservices.com is not responsible for the privacy practices or the content of those linked websites.</p>
            ...
            <p>If you want to remove your contact information from all ramrajservices.com lists and newsletters, please visit unsubscribe</p>

            <h3>7. Advertisements on ramrajservices.com</h3>
            ...
            Mr. Avinash K. Shukla <br>
            Ramraj services  Pvt Ltd. <br>
            PLOT NO. 27, VEDNATHPURAM SEMRA GAURI, SITAPUR ROAD LUCKNOW UP 226021 INDIA <br>
            Phone: 9630093998 <br>
            Email: info@ramrajservices.com <br>
            Time: Mon - Sat (10:00 - 18:00) <br>
            </p>
